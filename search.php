...
<body>
    ...
    <div id="id01" class="modal">
        ...
        <form name="form1" id="form1" class="modal-content animate" action="insertdebtor.php" method="post">
            ...
            <div class="imgcontainer">
                <span onclick="document.getElementById('id01').style.display='none'; clearInput()" class="close"
            ...
            <div class="container">
                ...
                <input id="id1" type="text" onfocus="this.value=''" placeholder="Enter Username" name="input-name"
                    onkeypress="return AvoidSpace(event)" required>

                <label class="label-text" for="input-phone#">Phone Number</label>
                <input id="id2" class="num" onfocus="this.value=''" type="tel" placeholder="Enter Phone#"
                    name="input-phone#" onkeypress="return onlyNumberKey(event)" required>

                <label class="label-text" for="input-address">Address</label>
                <input id="id3" type="text" onfocus="this.value=''" placeholder="Enter Address" name="input-address"
                    required>
    ...
    <div class="listOfDebtors-sub-remove-container">
        ...
        <form class="search-wrapper1 cf2" action="search.php" method="GET">
            <input type="text" placeholder="Search Names..." value="<?php echo $_REQUEST['search']; ?>" disabled
                style="box-shadow: none">
            <button class="search-wrapper1" type="submit" disabled>Search</button>
        </form>
...
//   $result2 = $conn->query($sql2);
        $sql = "SELECT d_id, d_name, phone, address, date_format((created_at), '%m/%d/%Y') AS date from debtors WHERE d_name LIKE '%$search%';";
      ...
      <div class='customer-box-lists'>
          ...
          <div>
              ...
              <p>Date Started: " . $row["date"] . "</p>";
                ...
                <a href=deletedebtor.php?bid=" . $row["d_id"] . " &bname=" . $row["d_name"] . " ' class='confirm-btn' style='text-decoration:none;'>Delete </a> 
      </div>";
                }
            }
        } else {
