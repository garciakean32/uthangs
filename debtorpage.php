    ...
    <form autocomplete="off" name="form1" id="form1" class="modal-content animate" action="edituser.php" method="post">
      ...
      <div class="container">
        ...
        <div class="cancel-confirm-btn-container">
          <button type="button" onclick="document.getElementById('edituser').style.display='none'; clearInput()"
  ...
  <div id="pay" class="modal" style="display: none;">
    ...
    <form autocomplete="off" name="form1" id="form1" class="modal-content animate" action="payall.php" method="post">
      ...
      <div class="pay-all-container">
        <center>
          <label class="label-text" for="input-name" onkeypress="return AvoidSpace(event)">Are you sure you want to
            ...
            while ($row = $result->fetch_assoc()) {
              ...
              echo
                "<tr class='tb'>
	                    ...
	                    <a href='edit.php? &bid=" . $row["u_id"] . " &bname=" . $row["item_name"] . "&quantity=" . $row["quantity"] . "' class='editbtn' >Edit </a>    </td></tr>";
            }
          } else {
            echo "No Record";
          }
